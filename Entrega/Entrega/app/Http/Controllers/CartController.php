...
class CartController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      $item = new Cart;
      $item->name = $titulo->name;
      $item->description = $titulo->description;
      $item->price = $titulo->price;
      $item->featured_img = $titulo->featured_img;
      $item->quantity = 1;
    ...
    public function cartclose(Request $req){
      //traigo todos los titulos del carrtito del usuario logueado.
